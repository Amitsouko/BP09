...
use Bp\ProductBundle\Form\SizeType;
...
class SizeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BpProductBundle:Size')->findAll();
     ...
     * @Method("POST")
     * @Template("BpProductBundle:Size:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BpProductBundle:Size')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BpProductBundle:Size:edit.html.twig")
     */
