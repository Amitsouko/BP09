...
use Bp\ProductBundle\Form\BrandType;
...
class BrandController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BpProductBundle:Brand')->findAll();
     ...
     * @Method("POST")
     * @Template("BpProductBundle:Brand:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BpProductBundle:Brand')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BpProductBundle:Brand:edit.html.twig")
     */
