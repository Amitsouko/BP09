...
use Bp\ProductBundle\Form\ProductType;
...
class ProductController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BpProductBundle:Product')->findAll();
     ...
     * @Method("POST")
     * @Template("BpProductBundle:Product:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BpProductBundle:Product')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BpProductBundle:Product:edit.html.twig")
     */
