...
use Bp\ProductBundle\Form\ColorType;
...
class ColorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BpProductBundle:Color')->findAll();
     ...
     * @Method("POST")
     * @Template("BpProductBundle:Color:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_color_show', array('id' => $entity->getId())));
        }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BpProductBundle:Color')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BpProductBundle:Color:edit.html.twig")
     */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_color'));
    }
