...
use Bp\ProductBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BpProductBundle:Category')->findAll();
     ...
     * @Method("POST")
     * @Template("BpProductBundle:Category:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BpProductBundle:Category')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BpProductBundle:Category:edit.html.twig")
     */
