...
use Bp\ProductBundle\Form\PackType;
...
class PackController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BpProductBundle:Pack')->findAll();
     ...
     *
     * @Route("/", name="admin_pack_create")
     * @Method("POST")
     * @Template("BpProductBundle:Pack:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BpProductBundle:Pack')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new PackType(), $entity, array(
            'action' => $this->generateUrl('admin_pack_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_pack_update")
     * @Method("PUT")
     * @Template("BpProductBundle:Pack:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_pack_delete', array('id' => $id)))
            ->setMethod('DELETE')
