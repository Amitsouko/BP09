...
class Type
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Bp\ProductBundle\Entity\Product", inversedBy="types",cascade={"persist"})
     * @ORM\JoinTable(name="type_product")
     **/
    private $products;

    /**
     * @ORM\ManyToMany(targetEntity="Bp\ProductBundle\Entity\Pack", inversedBy="types",cascade={"persist"})
