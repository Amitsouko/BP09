 ...
 * @ORM\Entity(repositoryClass="Bp\ProductBundle\Entity\CategoryRepository")
 */
class Category
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Bp\ProductBundle\Entity\Product", mappedBy="categories")
     **/
    private $products;


    /**
     * @ORM\ManyToMany(targetEntity="Bp\ProductBundle\Entity\Pack", mappedBy="categories")
     **/
    private $packs;
